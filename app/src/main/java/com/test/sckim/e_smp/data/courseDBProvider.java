...
public class courseDBProvider extends ContentProvider{


    public static final String PROVIDER_NAME = "com.test.sckim.e_smp.data.student";
    ...
    courseDBAdapter mCourseDB;

    public boolean onCreate() {
        mCourseDB = new courseDBAdapter(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if(uriMatcher.match(uri)==STUDENTS){
            return mCourseDB.getAllCourses();
        }else{
            return null;
        }
    }
